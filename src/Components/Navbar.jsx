            ...
            <div style={{ backgroundColor: PRIMARY_COLOR }} className="text-white py-3">
                <div className="max-w-7xl mx-auto px-4 md:px-8 flex justify-between items-center">
                    <div className="flex items-center space-x-4 md:space-x-10">
                        <div className="text-xl md:text-2xl font-extrabold tracking-tight cursor-pointer">HomeLand</div>
                    ...
                    <div className="flex items-center space-x-4 md:space-x-6 text-white font-medium">
                        ...
                        <button className="bg-white text-black font-bold rounded-full px-3 py-1 md:px-4 md:py-1.5 flex items-center space-x-2 shadow hover:opacity-90">
